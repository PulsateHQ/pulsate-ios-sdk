...
typedef SWIFT_ENUM(NSInteger, PULBeaconAction, closed) {
...
typedef SWIFT_ENUM(NSInteger, PULCallToActionType, closed) {
...
typedef SWIFT_ENUM(NSInteger, PULCurrency, closed) {
  PULCurrencyAUD = 0,
  PULCurrencyBGN = 1,
  PULCurrencyBRL = 2,
  PULCurrencyCAD = 3,
...
typedef SWIFT_ENUM(NSInteger, PULPrivacyLevel, closed) {
...
- (void)received:(PULInAppMessage * _Nullable)inAppMessage;
/// Shows the last in app notification. In App Notification need to be enabled.
/// To enable in app notifications use enableInAppNotification(BOOL).
...
typedef SWIFT_ENUM(NSInteger, PULUserGender, closed) {
