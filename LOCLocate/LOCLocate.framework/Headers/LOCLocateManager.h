...
#import "LOCLocateUnauthorizedManagerDelegate.h"
#import "LOCLocateBadgeDelegate.h"
#import <UIKit/UIKit.h>

@class UINavigationController;

@interface LOCLocateManager : NSObject

@property (nonatomic, retain) IBOutlet id<LOCLocateUnauthorizedManagerDelegate> unauthorizedDelegate;
@property (nonatomic, retain) IBOutlet id<LOCLocateBadgeDelegate> badgeDelegate;

typedef NS_ENUM(NSUInteger, LOCUserGender){
    LOCMale,
    LOCFemale
};
 ...
 */
-(void)updateGender:(LOCUserGender)gender;
...
/**
 *  If you chose to have push disabled when instantiating the Locate Manager, you can enable it later.
